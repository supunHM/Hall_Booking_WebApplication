...
<?php
    ...
    if(isset($_POST['admin_login']))
    {
      ...
      $stmt=$mysqli->prepare("SELECT admin_email, admin_password, admin_id FROM FCT_Admin WHERE admin_email=? and admin_password=? ");//sql to log in user
...
<head>
  ...
  <title>FCT Hall Booking System - Admin Login</title>
        ...
        <form method="POST">
          <div class="form-group">
            <div class="form-label-group">
              <input type="email" id="inputEmail" name="admin_email" class="form-control" placeholder="Email address" required="required" autofocus="autofocus">
              <label for="inputEmail">Email address</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
              <input type="password" id="inputPassword" name ="admin_password" class="form-control" placeholder="Password" required="required">
