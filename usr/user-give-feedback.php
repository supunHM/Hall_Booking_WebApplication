  ...
  if(isset($_POST['give_feedback']))
    {
            ...
            $f_status = 'Published';
            $query="INSERT INTO feedback (f_uname, f_content, f_status) VALUES (?, ?, ?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('sss', $f_uname, $f_content, $f_status);
            $stmt->execute();
                if($stmt)
                {
        ...
        <div class="card-body">
          ...
          <form method ="POST"> 
            ...
            <div class="form-group">
                ...
                <input type="text" required readonly class="form-control" value="<?php echo $row->u_f_name;?> <?php echo $row->u_l_name;?> " id="exampleInputEmail1" name="f_uname">
            </div>
            <?php }?>
            <div class="form-group">
