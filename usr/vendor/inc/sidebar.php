            ...
            <ul class="sidebar navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                      <h6 class="dropdown-header"><?php echo $row->u_f_name;?> <?php echo $row->u_l_name;?></h6>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                      <h6 class="dropdown-header">Available Halls:</h6>
                      <a class="dropdown-item" href="usr-book-hall.php">Book</a>
                    </div>
                  </li>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                      ...
                      <a class="dropdown-item" href="usr-book-hall.php">Add</a>
